(function (document) {
    ...
    var chatApplication = {
        stompClient: null,
        username: null,
        chatId: new URL(location.href).searchParams.get('chatId'),
        colors: [
        ...
        connect: function (event) {
            ...
            this.stompClient.connect(headers, (frame) =>{console.log('Connected:', frame)}, this.onConnected.bind(this), this.onError.bind(this));

            event.preventDefault();
        },
        onConnected: function () {
            this.stompClient.subscribe(`/exchange/chat.exchange/room.${this.chatId}`, this.onMessageReceived.bind(this));
        ...
        onMessageReceived: function (payload) {
            ...
            if (chat.type === 'ENTER') {
                ...
                chat.content = chat.sender + chat.contents;
                this.getUserList();
            ...
            var messageText = document.createTextNode(chat.contents);
